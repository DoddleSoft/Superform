...
import { LuPlus, LuSearch, LuChevronLeft, LuChevronRight, LuChevronDown, LuFolder, LuFileText, LuSparkles, LuArrowUpDown, LuSettings } from "react-icons/lu";
        ...
        <div className="space-y-6">
            ...
            <div className="bg-base-100 rounded-2xl border border-base-200 shadow-sm">
                                    ...
                                    <li key={ws.id}>
                                        <button
                                            className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors ${
                                                ws.id === currentWorkspace?.id ? "bg-primary/10 text-primary" : "hover:bg-base-200 text-base-content"
                                            }`}
                                            onClick={() => {
                ...
                <div className="flex items-center gap-2 w-full sm:w-auto">
                                ...
                                <li key={option.value}>
                                    <button
                                        className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-colors ${
                                            sortBy === option.value ? "bg-primary/10 text-primary" : "hover:bg-base-200 text-base-content"
                                        }`}
                    ...
                    {/* New Form Button */}
                    <button
                        className="flex items-center gap-2 px-4 py-2 bg-primary text-primary-content text-sm font-medium rounded-xl shadow-sm hover:bg-primary/90 transition-colors"
                    ...
                    <div className="bg-base-100 rounded-2xl border border-base-200 shadow-sm p-8 text-center max-w-md">
                        {debouncedSearch ? (
                            ...
                            <>
                                ...
                                <button
                                    className="flex items-center gap-2 px-5 py-2.5 bg-primary text-primary-content text-sm font-medium rounded-xl shadow-sm hover:bg-primary/90 transition-colors mx-auto"
                                    onClick={() => setIsCreateModalOpen(true)}
                                >
                                    <LuPlus className="w-4 h-4" />
                                    Create Form
