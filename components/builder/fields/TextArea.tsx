...
function FormComponent({
    ...
    return (
        <div className="flex flex-col gap-2 w-full">
            ...
            <textarea
                className={`w-full bg-transparent border-b border-[#262627]/30 text-2xl md:text-3xl py-2 focus:outline-none focus:border-[#0445AF] transition-colors placeholder:text-[#262627]/20 resize-none ${error ? "border-error" : ""}`}
                placeholder={placeholder}
                rows={rows}
                onChange={(e) => {
