                    ...
                    <header className="bg-base-100 border-b border-base-200 sticky top-0 z-40">
                        <div className="flex items-center justify-between h-14 px-4 lg:px-6 max-w-7xl mx-auto">
                            ...
                            <div className="flex items-center gap-2">
                                {/* Buy PRO Button */}
                                <button className="hidden sm:flex items-center gap-1.5 px-4 py-1.5 bg-gradient-to-r from-primary to-primary/90 text-primary-content text-sm font-medium rounded-lg shadow-sm hover:shadow transition-shadow">
                                    Try PRO
                                </button>
